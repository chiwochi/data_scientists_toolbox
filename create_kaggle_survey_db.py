...
class CreateKaggleSurveyDB:
    def __init__(self):
        ...
        #     印出整理後的資料
        # for survey_year in survey_years:
        #     print(df_dict[survey_year, "question_descriptions"])
    ...
    def tidy_2020_2021_data(self, survey_year: int) -> tuple:
        ...
        for column_name, questions_descriptions in zip(column_names, descriptions):
            column_name_split = column_name.split("_")
            questions_descriptions_split = questions_descriptions.split(" - ")
            if len(column_name_split) == 1:
                ...
                question_descriptions.append(questions_descriptions_split[0])
            else:
